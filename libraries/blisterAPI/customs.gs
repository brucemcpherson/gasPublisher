...
// custom functions for use with cBlister class
// this module is required in any spreadsheet you want to use these custom functions in.
// they should need changing
// you also need to include the blister library
//
// v1.1 sep 2013
